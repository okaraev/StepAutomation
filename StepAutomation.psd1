#
# Module manifest for module 'WebAutomate'
#
...
Description = @'
This module allows administrators to automate sequential steps (configuration based).

The module provides classes for automating. You can also easily extend the module with adding your own custom operations.
